/*
	...
	Configuration header for the Nordic nRF SDK, for the WOWL sensor.
...
// Note: an IRQ priority of 3 causes a Hard Fault if any service calls 
//   are made in the ISR call chain.  So we use 6.
...
#ifndef NRF_LOG_BACKEND_USES_TERMINAL_IO
#define NRF_LOG_BACKEND_USES_TERMINAL_IO   1
#endif
